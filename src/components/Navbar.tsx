  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled 
          ? "bg-[hsl(160,24%,8%)]/95 backdrop-blur-xl border-b border-white/10" 
          : "bg-transparent"
      }`}
    >
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#tools" className="text-white/70 hover:text-white transition-colors">
              Tools
            </a>
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <a href="#resources" className="text-white/70 hover:text-white transition-colors py-2">
                Resources
              </a>
