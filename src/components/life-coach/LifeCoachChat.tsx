...
const LifeCoachChat = () => {
  ...
  const streamChat = async (userMessages: Message[]) => {
    ...
    if (!session) {
      throw new Error("Please sign in to use the Life Coach.");
    }
      ...
      <div className="border-t border-border p-4 bg-card">
        <div className="flex gap-3">
          <Textarea
            ...
            disabled={isLoading}
          />
          <Button onClick={handleSend} disabled={!input.trim() || isLoading} size="icon" className="flex-shrink-0 h-11 w-11">
