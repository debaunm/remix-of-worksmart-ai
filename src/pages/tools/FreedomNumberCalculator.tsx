...
function getProgressMilestone(progressPercent: number): { level: string; label: string; description: string } {
  ...
  if (progressPercent >= 50) return { level: 'breathing', label: 'Breathing Room', description: 'Major flexibility' };
  if (progressPercent >= 25) return { level: 'safety', label: 'Safety Net', description: 'Can survive 1 week/month without job' };
  return { level: 'starting', label: 'Just Starting', description: 'Beginning your journey' };
}
...
const FreedomNumberCalculator = () => {
  ...
  const milestones = [
    { percent: 25, label: "Safety Net" },
    { percent: 50, label: "Breathing Room" },
    { percent: 75, label: "Almost There" },
    { percent: 100, label: "OPTIONS" },
  ];
      ...
      <main className="container mx-auto px-4 pt-28 pb-20 max-w-4xl">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            When Can I <span className="gradient-text">Quit?</span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Know exactly how much passive income you need to make work OPTIONAL—not mandatory. Calculate your Freedom Number in 60 seconds.
          </p>
        </motion.div>
              ...
              <form onSubmit={handleCalculate} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground font-medium">$</span>
                    <Input
                      id="currentPassiveIncome"
                      type="number"
                      className="pl-8 h-12 text-lg"
                      placeholder="0"
                      value={currentPassiveIncome}
                      onChange={(e) => setCurrentPassiveIncome(e.target.value)}
                      min="0"
                      max="100000"
                    />
                  </div>
              ...
              <Card className="border-border/50">
                ...
                <CardContent>
                  <div className="relative">
                    ...
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{ width: `${Math.min(results.progress, 100)}%` }}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="border-border/50">
              ...
              <CardContent className="text-muted-foreground">
                <p>Your Freedom Number is the monthly passive income that covers your essential living expenses. When your passive income equals your expenses, work becomes a <strong className="text-foreground">choice</strong>, not a requirement.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/50">
              ...
              <CardContent className="text-muted-foreground">
                <p>Unlike traditional retirement planning that requires saving 25x your expenses, building passive income streams lets you achieve financial freedom <strong className="text-foreground">faster</strong> by creating money that works while you sleep.</p>
              </CardContent>
            </Card>
