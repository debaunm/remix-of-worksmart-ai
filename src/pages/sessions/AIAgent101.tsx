...
const outcomes = [
  ...
  "Build your first autonomous AI workflow from scratch",
  "Leverage agents for research, analysis, and task automation",
  "Avoid common pitfalls that lead to unreliable agent outputs",
  "Create a personal AI agent strategy that saves hours weekly",
];

const sessionModules = [
  {
    title: "AI Agents Demystified",
    description: "What makes an AI agent different from ChatGPT—and why it matters for your productivity.",
    duration: "15 min",
  },
  {
    title: "The Agent Ecosystem",
    description: "Explore the leading AI agent platforms and understand which ones fit your use case.",
    duration: "15 min",
  },
  {
    title: "Building Your First Agent",
    description: "Hands-on walkthrough of creating an autonomous workflow that handles real tasks.",
    duration: "20 min",
  },
  {
    title: "Advanced Agent Strategies",
    description: "Multi-step reasoning, tool use, and chaining agents together for complex workflows.",
    duration: "10 min",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                Master the fundamentals of AI agents—how they work, when to use them, and how to leverage them to automate tasks and boost your productivity.
              </p>
        ...
        <div className="container mx-auto max-w-3xl text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              Ready to unlock the power of AI agents?
            </h2>
